...
<div class="container  bg-white mt-3 p-4">
    ...
    <div class="card">
        <div class="card-header">
            Form Edit Data Tugas
        </div>
        <div class="card-body">
            <form method="post" action="/tugas/{{$tugas->id}}">
                @csrf
                @method('PUT')
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Tugas</label>
                    <input type="text" value="{{$tugas->tugas}}" name="tugas" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                </div>
